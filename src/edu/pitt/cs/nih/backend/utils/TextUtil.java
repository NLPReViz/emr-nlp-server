...
public class TextUtil {
	 ...
	 * <p>
	 * We use Stanford parser to extract individual words in a document. 
	 * Each document has one or many lines. This method processes line by line. 
         * Each line contains one or more sentences.
	 * 
	 * @param text
	...
	public static ArrayList<String[]> extractWordsByStandfordParser(String text)
		...
		try {
                ...
                featureList.add(unigramPerLine.toArray(new String[unigramPerLine.size()]));
            }
	 ...
	 * <p>
	 * We use token to extract individual words in a document. 
	 * The default token is whitespace "\\s". 
	 * This approach is more simple than Stanford parser. 
	 * Each document has one or many lines. This method processes line by line.
	 * 
	 * @param text
	 * @return An array of which each element is an array of unigrams
	 * @throws Exception
	 */
	public static ArrayList<String[]> extractWordsByToken(String text, String token)
		throws Exception {
	...
	/**
	 * Split a document into array of sentences. This method 
	 * is a batch mode. It requires a StanfordCoreNLP object because 
	 * the creating time for this object is quite long. Creating 
	 * such an object for each document in a batch mode is a burden
	 * 
	 * @param text The document
	 * @param pipeline A StanfordCoreNLP object.
	 * @return
	 * @throws Exception
	 */
